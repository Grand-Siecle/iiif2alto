...
- Pour convertir des images depuis un manifeste IIIF : [Notebook](https://github.com/Grand-Siecle/iiif2alto/blob/main/notebook_iiif.ipynb) ;  version BAMBOO [Notebook](https://github.com/Grand-Siecle/iiif2alto/blob/main/notebook_iiif_bamboo.ipynb)
